...
基于100万+用户行为数据，完成以下分析：

- **用户转化漏斗**：总用户10000，浏览用户10000，加购用户8614，购买用户8886
- **活跃度分层**：高活跃用户（7147人）人均购买15.43次，是低活跃用户的11.6倍
- **周末vs工作日**：工作日总购买量（92972）显著高于周末（27233）
...
| 业务洞察 | 发现高活跃用户贡献11.6倍购买、工作日购买量更高 |
